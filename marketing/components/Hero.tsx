...
const Hero: React.FC<HeroProps> = ({ language, siteContent }) => {
  ...
  return (
    <section className="relative h-[85vh] flex items-center justify-center text-center text-white bg-cover bg-center" style={{ backgroundImage: "url('https://onlyhelio.com/images/background.jpg')" }}>
      ...
      <div className="relative z-20 px-4 container mx-auto flex flex-col items-center">
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-200 mb-10">
          {siteContent.heroSubtitle || 'في ONLY HELIO، نختص بتقديم روائع معمارية وخدمات متكاملة مصممة خصيصًا لتلبية طموحات سكان مدينة هليوبوليس الجديدة.'}
        </p>
        
        <div className="w-full max-w-4xl bg-gray-800/80 backdrop-blur-sm p-6 rounded-lg shadow-2xl border border-gray-700">
