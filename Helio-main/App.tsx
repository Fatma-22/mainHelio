...
import { getSiteContent, getSiteContentEn } from "./services/siteContentService";
      ...
      <div className="bg-gray-900 text-gray-200 flex flex-col min-h-screen">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route path="/decoration" element={<DecorationsPage language={language} />} />
            <Route path="/contact" element={<ContactPage language={language} siteContentAr={appData.siteContentAr} siteContentEn={appData.siteContentEn} />} />
            <Route path="/favorites" element={<FavoritesPage language={language} />} />
          </Routes>
        </main>
        <Footer language={language} siteContentAr={appData.siteContentAr} siteContentEn={appData.siteContentEn}/>
